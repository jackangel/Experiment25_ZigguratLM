...
# Use 8-bit optimizers for memory efficiency
try:
    import bitsandbytes.optim as bnb_optim
except ImportError:
    print("bitsandbytes not installed. Optimizers will use standard AdamW.")
...
if __name__ == '__main__':
    ...
    final_optimizer = bnb_optim.AdamW8bit(main_path_params, lr=3e-4, betas=(0.9, 0.95))
